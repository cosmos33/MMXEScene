...
******************************************************************************/
#ifndef XE_UI_ANIM_CONTROLLER_H
#define XE_UI_ANIM_CONTROLLER_H
#include "XMath3D.h"
#include "XEAnimControllerBase.h"
class XEUIAnimationInstance;
class XEUserNodeInstance;
class XEKeyframeBase;
class XEUIAnimController : public XEAnimControllerBase
{
public:
...
public:
	...
	X_FORCEINLINE void                SetUIAnimation(XEUIAnimationInstance* pUIAnimationIns){ m_pUIAnimationIns = pUIAnimationIns; }
	X_FORCEINLINE XEUIAnimationInstance* GetUIAnimation(){ return m_pUIAnimationIns; }
	/**
	*
