...
class Face : public Object, public XClass {

public:

    X_CLASS_DEF(xes::Face);
...
XESCENE_CONSTRUCTOR_ACCESS:
    ...
    X_INLINE xint32 GetTrackId() const {
        return m_nTrackId;
    }

    X_INLINE XVECTOR3 GetEulerAngle() const {
        return XVECTOR3(m_fPitch, m_fYaw, m_fRoll);
    }

    X_INLINE Rect GetBounds() const {
        return m_rBounds;
    }
...
XESCENE_CONSTRUCTOR_ACCESS:
    ...
    X_INLINE xint32 GetExpression() const {
        return m_nExpression;
    }
