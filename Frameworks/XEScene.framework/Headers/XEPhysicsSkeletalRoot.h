...
/*
* XEPhysicsSkeletalRoot:代表一个phy 资源，引擎底层中，phy资源路径和IXSkeletalPhysicsRes*是一一对应的。
* 因此不管几个XEPhysicsSkeletalRoot*，只要加载的phy资源路径一致，则所有XEPhysicsSkeletalRoot*共用同一个IXSkeletalPhysicsRes*。
